...
import { LayoutDashboard, BarChart3, Settings, Shield, Activity } from "lucide-react";
...
const BottomNav = ({ activeTab, onTabChange }: BottomNavProps) => (
  <div className="fixed bottom-0 left-0 right-0 z-50">
    <div className="glass-card border-t border-border/50 px-2 py-2 flex items-center justify-around max-w-md mx-auto">
      {tabs.map((tab) => {
        ...
        return (
          ...
          >
            {isActive && (
              <motion.div
                layoutId="activeTab"
                className="absolute -top-2 w-8 h-1 rounded-full gold-gradient"
